...
#Importando el modulo para crear la api-rest
from flask_restful import Api
#Importando el modulo para conectarme con una base de datos SQL
from flask_sqlalchemy import SQLAlchemy
#Importando el modulo para trabajar con JWT
from flask_jwt_extended import JWTManager
#Importando el modulo para trabajar con mail
